...
*/
$services_set_plugin_root = plugin_dir_path(__FILE__);
$services_set_plugin_root_url = plugin_dir_url(__FILE__);
/* --------------------------------------------------------------------------------
* 0. Setup product post type and product taxonomy
*/
require_once( $services_set_plugin_root . 'inc/cpt-services.php' );
 ...
 * template tags
*/
require_once( $services_set_plugin_root . 'inc/template-tags.php' );
/*
...
if( !function_exists('menu_include_template_tags' ) ) {
    function menu_include_template_tags() {
        global $services_set_plugin_root;
        include_once( $services_set_plugin_root . 'inc/template-tags.php' );
    }
