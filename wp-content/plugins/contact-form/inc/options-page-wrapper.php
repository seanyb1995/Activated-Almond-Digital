<div class="wrap">
    ...
    ?>
        ...
        <table class="widefat">
            <thead>
                <tr>
                    ...
                    <th><?php esc_attr_e( 'Help', 'contactform' ); ?></th>
                    <th><?php esc_attr_e( 'Budget', 'contactform' ); ?></th>
                    <th><?php esc_attr_e( 'Time', 'contactform' ); ?></th>
        ...
        <tr>
          ...
          <td><?php esc_attr_e( $row->help, 'contactform' ); ?></td>
          <td><?php esc_attr_e( $row->budget, 'contactform' ); ?></td>
          <td><?php esc_attr_e( $row->Time, 'contactform' ); ?></td>
